                            ...
                            {      
                                ...
                                {             
                                    ...
                                    { 
                                            ...
                                            elseif([string]::IsNullOrEmpty($row.EclipseId) -and [string]::IsNullOrEmpty($EclipseId))
                                            {
                                                $IsEclipseIdSame =  "Same"
                                            } 
                                            ...
                                            $LastModifiedFile | Add-Member -MemberType NoteProperty -Name "Target File Name" -Value $document["FileLeafRef"] 
                                            ...
                                            $LastModifiedFile | Add-Member -MemberType NoteProperty -Name "Target Document URL" -Value ("https://euteamsites.willistowerswatson.com" + $document["FileRef"])
                                            $LastModifiedFile | Add-Member -MemberType NoteProperty -Name "Source Modified By (Login Name)" -Value $row.'Modified By (Login Name)'
                                            $LastModifiedFile | Add-Member -MemberType NoteProperty -Name "Target Modified By (Login Name)" -Value $document["Editor"].LookupValue
