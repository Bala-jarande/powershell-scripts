                                        ...
                                        if($TLists.ListTitle[$j] -eq $SLists.ListTitle[$i])
                                        {
                                                ...
                                                if($TLists.ItemCount[$j] -ne $SLists.ItemCount[$i])
                                                {
                                                        ...
                                                        else
                                                        {
                                                            if($SLists.ListBaseTemplate[$i] -ne "GenericList")
                                                            {
                                                                $SourceListItems = Get-ListItemLargeList -Context $Context -ListTitle $SLists.ListTitle[$i] -qry $qryFiles -ListURL $SLists.ListURL[$i] -WebURL $SLists.WebURL[$i]
                                                                $TargetListItems = Get-ListItemLargeList -Context $TargetContext -ListTitle $TLists.ListTitle[$j] -qry $qryFiles -ListURL $TLists.ListURL[$j] -WebURL $TLists.WebURL[$j]
                                                            } 
